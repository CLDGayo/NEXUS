...
const MD_COMPONENTS = {
  ...
  p: (props) => <p className="my-1 first:mt-0 last:mb-0 text-sm text-slate-700" {...props} />,
  ul: (props) => <ul className="my-1 list-disc space-y-0.5 pl-5 text-sm text-slate-700" {...props} />,
  ol: (props) => <ol className="my-1 list-decimal space-y-0.5 pl-5 text-sm text-slate-700" {...props} />,
...
export default function ChangelogEntry({ entry }) {
  ...
  return (
    <article className="rounded-xl border border-nexus-border bg-white p-5 shadow-sm">
